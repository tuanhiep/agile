...
INSERT INTO ase.Comment(idComment,content,Issue_idIssue,User_idUser)VALUES(5,"Our team has one member who cannot continue to work, please review the estimation points ",1,3);
INSERT INTO ase.Comment(idComment,content,Issue_idIssue,User_idUser)VALUES(5,"Please add more information about BA work, we shoudl clarify this problem as soon as possible",1,2);
INSERT INTO ase.Comment(idComment,content,Issue_idIssue,User_idUser)VALUES(5,"This work should be suspended for a while ",1,3);
INSERT INTO ase.Comment(idComment,content,Issue_idIssue,User_idUser)VALUES(5,"We use another sprint for this work ",1,1);
INSERT INTO ase.Comment(idComment,content,Issue_idIssue,User_idUser)VALUES(5,"Does someone create a new issue for the continue of this issue ? ",2,2);
INSERT INTO ase.Comment(idComment,content,Issue_idIssue,User_idUser)VALUES(5,"I assign more BA for this problem because we need to has the same view for the solution",1,3);
