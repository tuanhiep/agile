...
-- -----------------------------------------------------
-- Table `ase`.`ProjectBacklog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ase`.`ProjectBacklog` ;

CREATE TABLE IF NOT EXISTS `ase`.`ProjectBacklog` (
  `idProjectBacklog` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idProjectBacklog`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ase`.`Project` (
  ...
  `ProjectBacklog_idProjectBacklog` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idProject`),
  INDEX `fk_Project_ProjectBacklog_idx` (`ProjectBacklog_idProjectBacklog` ASC) VISIBLE,
  CONSTRAINT `fk_Project_ProjectBacklog`
    FOREIGN KEY (`ProjectBacklog_idProjectBacklog`)
    REFERENCES `ase`.`ProjectBacklog` (`idProjectBacklog`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ase`.`SprintBacklog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ase`.`SprintBacklog` ;

CREATE TABLE IF NOT EXISTS `ase`.`SprintBacklog` (
  `idSprintBacklog` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`idSprintBacklog`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ase`.`Sprint` (
  ...
  `startDate` DATETIME NULL,
  `endDate` DATETIME NULL,
  `SprintBacklog_idSprintBacklog` INT UNSIGNED NOT NULL,
  `Project_idProject` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idSprint`),
  INDEX `fk_Sprint_SprintBacklog1_idx` (`SprintBacklog_idSprintBacklog` ASC) VISIBLE,
  INDEX `fk_Sprint_Project1_idx` (`Project_idProject` ASC) VISIBLE,
  CONSTRAINT `fk_Sprint_SprintBacklog1`
    FOREIGN KEY (`SprintBacklog_idSprintBacklog`)
    REFERENCES `ase`.`SprintBacklog` (`idSprintBacklog`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `ase`.`Issue` (
  ...
  `SprintBacklog_idSprintBacklog` INT UNSIGNED NOT NULL,
  `ProjectBacklog_idProjectBacklog` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idIssue`, `SprintBacklog_idSprintBacklog`, `ProjectBacklog_idProjectBacklog`),
  ...
  INDEX `fk_Issue_SprintBacklog1_idx` (`SprintBacklog_idSprintBacklog` ASC) VISIBLE,
  INDEX `fk_Issue_ProjectBacklog1_idx` (`ProjectBacklog_idProjectBacklog` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Issue_User2`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Issue_SprintBacklog1`
    FOREIGN KEY (`SprintBacklog_idSprintBacklog`)
    REFERENCES `ase`.`SprintBacklog` (`idSprintBacklog`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Issue_ProjectBacklog1`
    FOREIGN KEY (`ProjectBacklog_idProjectBacklog`)
    REFERENCES `ase`.`ProjectBacklog` (`idProjectBacklog`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
